...
public class InboxAdapter extends ArrayAdapter<ParseObject> {
    ...
    public InboxAdapter(Context context, List<ParseObject> playtests) {
        super(context, R.layout.inbox_item, playtests);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.inbox_item, null);
