...
import javcarroz.com.playtestabacus.ui.adapters.ArchiveAdapter;
...
public class ArchiveFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Toast.makeText(getActivity(), "Refreshing archive!", Toast.LENGTH_LONG).show();
                retrieveTests();
            }
        });
    ...
    private void retrieveTests() {
        ...
        query.whereEqualTo(ParseConstants.PLAYTESTS_KEY_TEST_STATUS, ParseConstants.VALUE_TEST_STATUS_DONE);
            ...
            public void done(List<ParseObject> playtests, ParseException e) {
                ...
                if (e == null) {
                    ...
                    if (getListView().getAdapter() == null) {
                        ArchiveAdapter adapter = new ArchiveAdapter(getListView().getContext(), mPlaytests);
                        setListAdapter(adapter);
                    } else {
                        ((ArchiveAdapter) getListView().getAdapter()).refill(mPlaytests);
                    }
                } else {
                    Log.e(TAG, e.getMessage());
                    AlertDialog.Builder builder = new AlertDialog.Builder(getListView().getContext());
                    builder.setMessage(R.string.archive_failed_load_playtests_error_text)
                            .setTitle(R.string.archive_failed_load_playtests_error_title)
